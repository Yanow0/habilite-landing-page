  ...
  return (
    <section>
      <div className="max-w-full mx-auto px-4 sm:px-6 relative">
          ...
          <svg className="max-w-full hidden" width="564" height="552" viewBox="100 350 564 552" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="illustration-02" x1="-3.766" y1="300.204" x2="284.352" y2="577.921" gradientUnits="userSpaceOnUse">
                <stop stopColor="#187588" stopOpacity="1" />
                <stop offset="1" stopColor="#187588" stopOpacity="1" />
              </linearGradient>
            </defs>
        ...
        {/* Hero content */}
        <div className="relative pt-40 pb-2 md:pt-52 md:pb-2">

          {/* Section header */}
          <div className="max-w-full mx-auto text-center pb-2 md:pb-16 md:px-12">
            <div className="md:grid md:grid-cols-12 items-center mb-12 md:mb-16">
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-6 lg:col-span-6 pb-4 md:pb-0 lg:pb-0 md:order-0 text-left border-b-0 lg:border-b-0 md:border-b-0 md:border-r-2 lg:border-r-2 border-primary-dark-blue text-center md:text-left lg:text-left" data-aos="fade-right">
                <p className="text-xl md:text-3xl text-black font-dmsans px-4 md:px-16 lg:px-16" data-aos="fade-right" data-aos-delay="200">Avec Habilité tu pourras souscrire simultanément aux abonnements fibre, eau, gaz, électricité et assurance habitation en quelques clics !</p>
              </div>
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-6 lg:col-span-6 md:mb-0 mt-4 md:mt-0" data-aos="fade-left">
                <h1 className="h1 md:text-6xl font-aquatico text-primary-dark-blue hidden md:block lg:block" data-aos="fade-left">HABILITE</h1>
              </div>
            </div>
          ...
          {/* <ModalVideo
            ...
            video="/videos/PresentationHabilite.mp4"
            videoWidth={1920}
            videoHeight={1080} /> */}
